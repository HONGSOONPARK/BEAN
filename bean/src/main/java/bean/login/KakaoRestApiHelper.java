...
public class KakaoRestApiHelper {
    ...
    private static final String USER_AUTH_PATH = "/oauth/authorize";
    ...
    public String auth(final Map<String, String> params) {
        return request(HttpMethodType.GET, USER_AUTH_PATH, "?"+mapToParams(params), AUTH_SERVER_HOST);
    }

    public String token(final Map<String, String> params) throws Exception  {
        return request(HttpMethodType.POST, USER_TOKEN_PATH, mapToParams(params), AUTH_SERVER_HOST);
    }
    ...
    public String request(final HttpMethodType httpMethod, final String apiPath, final String params) {
        return request(httpMethod, apiPath, params, API_SERVER_HOST);
    }



    public String request(HttpMethodType httpMethod, final String apiPath, final String params, final String serverPath) {

        String requestUrl = serverPath + apiPath;
        if (httpMethod == null) {
